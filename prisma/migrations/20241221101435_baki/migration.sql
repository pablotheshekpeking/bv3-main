...
-- CreateEnum
CREATE TYPE "ListingType" AS ENUM ('APARTMENT_RENT', 'APARTMENT_SALE', 'APARTMENT_SHORTLET', 'CAR_SALE', 'CAR_RENT', 'ELECTRONICS', 'FURNITURE', 'OTHER');

-- CreateEnum
CREATE TYPE "ListingStatus" AS ENUM ('DRAFT', 'ACTIVE', 'SOLD', 'RENTED', 'EXPIRED', 'REMOVED');
